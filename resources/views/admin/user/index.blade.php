                ...
                <div class="flex-1 min-w-[140px] relative z-40">
                    ...
                    <div id="custom-role-menu" class="absolute left-0 top-[calc(100%+0.5rem)] w-full bg-white dark:bg-gray-800 rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] border border-slate-200 dark:border-gray-700 hidden z-50">
                        ...
                        <ul class="relative z-10 py-1" id="custom-role-options">
                            <li data-value="" class="px-4 py-2.5 text-sm cursor-pointer transition-colors {{ request('role') == '' ? 'bg-red-100 dark:bg-red-900/20 text-[#af101a] dark:text-red-400 font-bold' : 'text-slate-700 dark:text-gray-300 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-[#af101a] dark:hover:text-red-400' }} rounded-t-lg">Semua Peran</li>
                            <li data-value="admin" class="px-4 py-2.5 text-sm cursor-pointer transition-colors {{ request('role') == 'admin' ? 'bg-red-100 dark:bg-red-900/20 text-[#af101a] dark:text-red-400 font-bold' : 'text-slate-700 dark:text-gray-300 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-[#af101a] dark:hover:text-red-400' }}">Admin</li>
                            <li data-value="pemilik" class="px-4 py-2.5 text-sm cursor-pointer transition-colors {{ request('role') == 'pemilik' ? 'bg-red-100 dark:bg-red-900/20 text-[#af101a] dark:text-red-400 font-bold' : 'text-slate-700 dark:text-gray-300 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-[#af101a] dark:hover:text-red-400' }}">Pemilik</li>
                            <li data-value="user" class="px-4 py-2.5 text-sm cursor-pointer transition-colors {{ request('role') == 'user' ? 'bg-red-100 dark:bg-red-900/20 text-[#af101a] dark:text-red-400 font-bold' : 'text-slate-700 dark:text-gray-300 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-[#af101a] dark:hover:text-red-400' }} rounded-b-lg">Pengguna</li>
                        </ul>
                    </div>
                </div>
