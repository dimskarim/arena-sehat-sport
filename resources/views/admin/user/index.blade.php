...
<div class="max-w-[1280px] mx-auto font-['Inter'] text-[#1b1c1c] dark:text-white">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-gray-800 p-4 rounded-xl border border-[#e4beba] dark:border-gray-700 shadow-sm flex flex-wrap items-end gap-4">
            <form method="GET" action="{{ route('admin.users.index') }}" class="flex flex-wrap items-end gap-4 w-full">
                <div class="flex-1 min-w-[140px]">
                    ...
                    <select name="role" class="w-full px-3 py-2 bg-[#fcf9f8] dark:bg-gray-700/50 border border-[#e4beba] dark:border-gray-600 rounded-lg text-sm dark:text-white focus:ring-2 focus:ring-red-100 focus:border-[#af101a] dark:focus:ring-red-500/30 outline-none appearance-none cursor-pointer">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="px-4 py-2 text-[#af101a] dark:text-red-400 text-sm font-bold hover:bg-[#fdcbd0] dark:hover:bg-red-900/30 rounded-lg transition-colors">
                        Clear
                    </a>
                </div>
            </form>
    ...
    {{-- Data Table --}}
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-[#e4beba] dark:border-gray-700 overflow-hidden">
