...
<div class="max-w-[1280px] mx-auto font-['Inter'] text-[#1b1c1c] dark:text-white">
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-4 space-y-6">
            ...
            {{-- Tips Card --}}
            <div class="bg-gradient-to-br from-red-50 to-[#fdcbd0]/30 dark:from-red-900/20 dark:to-red-900/10 rounded-xl border border-[#e4beba] dark:border-red-900/50 p-5">
