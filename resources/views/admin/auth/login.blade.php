        ...
        <div class="w-full max-w-md bg-white dark:bg-darkCard rounded-2xl shadow-xl overflow-hidden transition-colors duration-300">
            <div class="p-8">
                ...
                <form action="{{ route('admin.login.submit') }}" method="POST" class="space-y-5">
                    @csrf
                    <div>
                        <label for="email" class="block text-sm font-medium mb-1 dark:text-gray-300">Email Address</label>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm font-medium text-tertiary hover:text-primary transition-colors">Lupa Password?</a>
                    </div>
