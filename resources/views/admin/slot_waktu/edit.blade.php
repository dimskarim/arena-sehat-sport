...
<div class="max-w-[1280px] mx-auto font-['Inter'] text-slate-900">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
            <div class="flex items-center gap-2 text-sm text-slate-500 dark:text-gray-400 mb-2">
                ...
                <span class="text-slate-900 dark:text-white font-semibold">Ubah Slot Waktu</span>
            </div>
            <h1 class="font-['Lexend'] text-[32px] font-semibold tracking-tight text-slate-900 dark:text-white">Ubah Data Slot Waktu</h1>
            <p class="text-slate-500 dark:text-gray-400 text-sm mt-1">Perbarui jadwal jam operasional untuk penyewaan lapangan.</p>
        </div>
    ...
    <form id="editForm" action="{{ route('admin.slot-waktus.update', $item->id) }}" method="POST">
        @csrf
        @method('PUT')
