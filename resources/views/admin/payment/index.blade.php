...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <nav>
        <a href="{{ route('admin.payments.create') }}" class="inline-flex items-center justify-center rounded-md bg-brand-500 py-2 px-6 text-center font-medium text-white hover:bg-opacity-90">
            Tambah Data
        </a>
    </nav>
</div>
        ...
        <table class="w-full table-auto">
            <thead>
                <tr class="bg-gray-2 text-left dark:bg-meta-4">
                    ...
                    <th class="py-4 px-4 font-medium text-black dark:text-white">Booking ID</th>
                    <th class="py-4 px-4 font-medium text-black dark:text-white">Metode</th>
                    <th class="py-4 px-4 font-medium text-black dark:text-white">Status</th>
                    <th class="py-4 px-4 font-medium text-black dark:text-white">Jumlah Bayar</th>
                ...
                <tr>
                    ...
                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <div class="flex items-center space-x-3.5">
                            <a href="{{ route('admin.payments.edit', $item->id) }}" class="hover:text-brand-500">Edit</a>
