                    ...
                    <div class="relative w-full z-40">
                        ...
                        <div id="custom-status-menu" class="absolute left-0 top-[calc(100%+0.5rem)] w-full bg-white dark:bg-gray-800 rounded-xl shadow-[0_4px_15px_rgba(0,0,0,0.1)] border border-[#e4beba] dark:border-gray-700 hidden z-50">
                            ...
                            <ul class="relative z-10 py-1" id="custom-status-options">
                                <li data-value="" class="px-4 py-2.5 text-sm cursor-pointer transition-colors {{ request('status') == '' ? 'bg-red-100 dark:bg-red-900/20 text-[#af101a] dark:text-red-400 font-bold' : 'text-[#5b403d] dark:text-gray-300 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-[#af101a] dark:hover:text-red-400' }} rounded-t-lg">Semua Status</li>
                                <li data-value="pending" class="px-4 py-2.5 text-sm cursor-pointer transition-colors {{ request('status') == 'pending' ? 'bg-red-100 dark:bg-red-900/20 text-[#af101a] dark:text-red-400 font-bold' : 'text-[#5b403d] dark:text-gray-300 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-[#af101a] dark:hover:text-red-400' }}">Pending</li>
                                <li data-value="confirmed" class="px-4 py-2.5 text-sm cursor-pointer transition-colors {{ request('status') == 'confirmed' ? 'bg-red-100 dark:bg-red-900/20 text-[#af101a] dark:text-red-400 font-bold' : 'text-[#5b403d] dark:text-gray-300 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-[#af101a] dark:hover:text-red-400' }}">Confirmed</li>
                                <li data-value="completed" class="px-4 py-2.5 text-sm cursor-pointer transition-colors {{ request('status') == 'completed' ? 'bg-red-100 dark:bg-red-900/20 text-[#af101a] dark:text-red-400 font-bold' : 'text-[#5b403d] dark:text-gray-300 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-[#af101a] dark:hover:text-red-400' }}">Completed</li>
                                <li data-value="cancelled" class="px-4 py-2.5 text-sm cursor-pointer transition-colors {{ request('status') == 'cancelled' ? 'bg-red-100 dark:bg-red-900/20 text-[#af101a] dark:text-red-400 font-bold' : 'text-[#5b403d] dark:text-gray-300 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-[#af101a] dark:hover:text-red-400' }} rounded-b-lg">Cancelled</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            statusOptions.forEach(option => {
                option.addEventListener('click', function() {
                    ...
                    statusOptions.forEach(opt => {
                        ...
                        opt.classList.add('text-[#5b403d]', 'dark:text-gray-300', 'hover:bg-red-100', 'dark:hover:bg-red-900/30', 'hover:text-[#af101a]', 'dark:hover:text-red-400');
                    });

                    this.classList.remove('text-[#5b403d]', 'dark:text-gray-300', 'hover:bg-red-100', 'dark:hover:bg-red-900/30', 'hover:text-[#af101a]', 'dark:hover:text-red-400');
