    ...
    <form action="{{ route('admin.notifications.store') }}" method="POST">
        ...
        <div class="p-6.5">
            ...
            <div class="mb-4.5">
                ...
                <input type="text" name="deskripsi" value="{{ old('deskripsi') }}" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input" />
            ...
            <div class="mb-4.5">
                ...
                <textarea name="pesan" required rows="4" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input">{{ old('pesan') }}</textarea>
