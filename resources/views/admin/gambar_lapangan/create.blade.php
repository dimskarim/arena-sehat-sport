...
<div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
    <form action="{{ route('admin.gambar-lapangans.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="p-6.5">
            <div class="mb-4.5">
            ...
            <div class="mb-4.5">
                <label class="mb-2.5 block text-black dark:text-white">Gambar <span class="text-meta-1">*</span></label>
                <input type="file" name="gambar_file" required class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input" />
