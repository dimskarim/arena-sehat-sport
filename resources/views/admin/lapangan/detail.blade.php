                            ...
                            <div class="relative w-full z-40">
                                ...
                                <div id="custom-status-menu" class="absolute left-0 top-[calc(100%+0.5rem)] w-full bg-white dark:bg-gray-800 rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] border border-slate-200 dark:border-gray-700 hidden z-50">
                                    ...
                                    <ul class="relative z-10 py-1" id="custom-status-options">
                                        <li data-value="tersedia" class="px-4 py-3 text-sm cursor-pointer transition-colors {{ old('status', $item->status) == 'tersedia' ? 'bg-red-100 text-[#af101a] font-bold' : 'text-slate-700 hover:bg-red-100 hover:text-[#af101a]' }} dark:text-gray-300 dark:hover:bg-red-900/30 dark:hover:text-red-400 rounded-t-lg">✅ Tersedia (Aktif)</li>
                                        <li data-value="nonaktif" class="px-4 py-3 text-sm cursor-pointer transition-colors {{ old('status', $item->status) == 'nonaktif' ? 'bg-red-100 text-[#af101a] font-bold' : 'text-slate-700 hover:bg-red-100 hover:text-[#af101a]' }} dark:text-gray-300 dark:hover:bg-red-900/30 dark:hover:text-red-400 rounded-b-lg">⛔ Tidak Tersedia (Tidak Aktif)</li>
                                    </ul>
                                </div>
                            </div>
