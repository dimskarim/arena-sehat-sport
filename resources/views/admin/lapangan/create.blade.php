    ...
    <form action="{{ route('admin.lapangans.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-6.5">
            ...
            <div class="mb-4.5">
                ...
                <textarea name="deskripsi" rows="4" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input">{{ old('deskripsi') }}</textarea>
            ...
            <div class="mb-4.5">
                ...
                <input type="number" name="harga" value="{{ old('harga') }}" required min="0" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input" />
            ...
            <div class="mb-4.5">
                <label class="mb-2.5 block text-black dark:text-white">Gambar Utama <span class="text-meta-1">*</span></label>
                <input type="file" name="gambar" required class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input" />
