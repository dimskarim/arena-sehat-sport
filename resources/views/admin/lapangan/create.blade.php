            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="deskripsi" rows="4"
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-red-100 focus:border-red-500 outline-none transition-all resize-none dark:bg-gray-700/50 dark:border-gray-600 dark:text-white dark:focus:ring-red-500/30"
                ...
                <div class="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="p-6 flex flex-wrap gap-2">
                        ...
                        <button type="button"
                            onclick="this.classList.toggle('bg-red-50'); this.classList.toggle('text-red-700'); this.classList.toggle('border-red-200'); this.classList.toggle('bg-slate-50'); this.classList.toggle('text-slate-600'); this.classList.toggle('border-slate-200'); this.classList.toggle('dark:bg-red-900/20'); this.classList.toggle('dark:text-red-400'); this.classList.toggle('dark:border-red-800'); this.classList.toggle('dark:bg-gray-700'); this.classList.toggle('dark:text-gray-300'); this.classList.toggle('dark:border-gray-600');"
                            class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 text-slate-600 text-xs font-semibold rounded-full border border-slate-200 cursor-pointer hover:border-red-200 hover:bg-red-50 hover:text-red-700 transition-all select-none dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:border-red-800 dark:hover:bg-red-900/20 dark:hover:text-red-400">
                ...
                <div class="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <label for="gambarInput" class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed {{ $errors->has('gambar') ? 'border-red-400 bg-red-50/30 dark:bg-red-900/20' : 'border-slate-200 dark:border-gray-600' }} rounded-xl cursor-pointer hover:border-red-300 hover:bg-red-50/30 transition-all group dark:hover:border-red-500 dark:hover:bg-red-900/20">
                            ...
                            <p class="text-[10px] text-slate-400 dark:text-gray-500 mt-0.5">PNG, JPG hingga 5MB</p>
                        </label>
                ...
                <div class="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="p-6">
                        ...
                        <select name="status" required
                            class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-red-100 focus:border-red-500 outline-none transition-all appearance-none cursor-pointer dark:bg-gray-700/50 dark:border-gray-600 dark:text-white dark:focus:ring-red-500/30">
