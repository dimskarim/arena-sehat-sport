...
<div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
    <form action="{{ route('admin.oprational-waktus.update', $item->id) }}" method="POST">
        ...
        <div class="p-6.5">
            ...
            <div class="mb-4.5">
                <label class="mb-2.5 block text-black dark:text-white">Hari <span class="text-meta-1">*</span></label>
            ...
            <div class="mb-4.5">
                <label class="mb-2.5 block text-black dark:text-white">Waktu Buka <span class="text-meta-1">*</span></label>
            ...
            <div class="mb-4.5">
                <label class="mb-2.5 block text-black dark:text-white">Waktu Tutup <span class="text-meta-1">*</span></label>
