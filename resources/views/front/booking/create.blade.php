                        ...
                        <div class="p-6 md:p-8 space-y-6">
                            ...
                            <div class="space-y-3 pt-2">
                                ...
                                <div class="relative w-full z-40">
                                    ...
                                    <div id="custom-dropdown-payment-btn" class="flex items-center justify-between bg-white hover:bg-blue-50 transition-colors px-5 py-4 rounded-xl border border-blue-500 cursor-pointer w-full">
                                        <span class="text-gray-900 font-bold text-[15px]" id="custom-dropdown-payment-text">
                                    ...
                                    <div id="custom-dropdown-payment-menu" class="absolute left-0 top-[110%] w-full bg-[#f9fafa] rounded-xl shadow-[0_4px_15px_rgba(0,0,0,0.08)] hidden z-40">
                                        <!-- Upward Pointer -->
                                        ...
                                        <ul class="relative z-10 py-2" id="custom-dropdown-payment-options">
                                            <li data-value="transfer" class="px-5 py-3 text-[15px] cursor-pointer transition-colors bg-[#f0f2f5] text-blue-600 font-bold">Transfer Bank (BCA/Mandiri/BNI)</li>
                                            <li data-value="ewallet" class="px-5 py-3 text-[15px] cursor-pointer transition-colors text-gray-500 font-medium hover:bg-[#f0f2f5] hover:text-blue-600">E-Wallet (GoPay/OVO/Dana)</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        payOptions.forEach(option => {
            option.addEventListener('click', function() {
                ...
                payOptions.forEach(opt => {
                    opt.classList.remove('bg-[#f0f2f5]', 'text-blue-600', 'font-bold');
                    opt.classList.add('text-gray-500', 'font-medium');
                });

                this.classList.remove('text-gray-500', 'font-medium');
                this.classList.add('bg-[#f0f2f5]', 'text-blue-600', 'font-bold');
